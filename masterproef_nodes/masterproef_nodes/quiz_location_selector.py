...
class QuizLocationSelector(Node):
    def __init__(self):
        ...
        self.csv_path = "/home/tycho/pi4_ws/data/quiz_location.csv"  # CHANGE THIS PATH TO THE CORRECT PATH ON THE JETSON
    ...
    def save_points_to_csv(self):
        try:
            with open(self.csv_path, mode='w', newline='') as file:
                ...
                writer.writerow(['X1', 'Y1', 'X2', 'Y2'])  # Location and Orientation point
